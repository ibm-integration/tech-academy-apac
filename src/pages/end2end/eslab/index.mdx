...
1. Back to CP4I Platform Navigator, open the ***ACE Dashboard***.
...
15. In the next page navigate to the operation implemented in your flow (***POST /contacts***). Then click on the ***Try it*** tab followed by the ***Generate*** hyperlink to generate some test data. Review the data generated and click the ***Send*** button.
